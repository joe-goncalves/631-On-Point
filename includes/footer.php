		...
		<div class='row'>
			<div class='col-md-8'>
				<div class='row'>
					...
					<div class="col-md-4 text-center">
						<a href="./images/onpoint-pdf.pdf" target="_blank">
							<i class="fa fa-file-pdf-o"></i><small>&nbsp;Download Our Brochure</small>
						</a>
					</div>
				</div>
			</div>
			<div class="col-md-4 text-center">
				<a href="./sitemap.php"><small>Sitemap</a>&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-copyright"></i> 631 On Point Locating<small>
			</div>
	</div>
...
<script>
  ...
  ga('create', 'UA-47302310-1', '631onpoint.com');
  ga('send', 'pageview');
